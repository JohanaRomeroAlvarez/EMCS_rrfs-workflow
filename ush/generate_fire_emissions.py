...
# Workflow
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
def generate_emiss_workflow(staticdir, ravedir, newges_dir, predef_grid, ebb_dcycle, restart_interval, rave_qa_filter):
   ...
   print('you are using ebb_dcyc:',ebb_dcycle)
   if not first_day:
       ...
       if use_dummy_emiss:
           ...
           i_tools.interpolate_rave(RAVE, rave_avail, rave_avail_hours,
                                    ...
                                    intp_dir, src_latt, tgt_latt, tgt_lont, cols, rows, rave_qa_filter)
